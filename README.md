...
```shell
curl https://raw.githubusercontent.com/ayudadigital/devcontrol/master/install.sh | sudo bash
```
...
>>>> DEBUG >>>>> 2019-08-24 19:32:31 devcontrol: Devcontrol (c) 2020 Ayuda Digital
